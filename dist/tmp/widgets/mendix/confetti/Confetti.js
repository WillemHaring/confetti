...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "ab534d7c360463f6ca76";
...
/******/ 	return hotCreateRequire("./src/Confetti.tsx")(__webpack_require__.s = "./src/Confetti.tsx");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/ui/Button.css":
/*!********************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/ui/Button.css ***!
  \********************************************************************************************************/
/*! no static exports found */
...
// Module
exports.push([module.i, ".widget-button {\n  display: inline-block;\n}\n\n.widget-button-text {\n  white-space: nowrap;\n  padding-right: 5px;\n}", ""]);
// Exports
...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/ui/Confetti.css":
/*!**********************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/ui/Confetti.css ***!
  \**********************************************************************************************************/
/*! no static exports found */
...
/* harmony import */ var _components_ConfettiComponent__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/ConfettiComponent */ "./src/components/ConfettiComponent.tsx");
...
/* harmony import */ var _ui_Confetti_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ui/Confetti.css */ "./src/ui/Confetti.css");
/* harmony import */ var _ui_Confetti_css__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_ui_Confetti_css__WEBPACK_IMPORTED_MODULE_3__);
...
var Confetti = /** @class */ (function (_super) {
    ...
    function Confetti(props) {
        ...
        _this.onClick = function () {
            _this.setState({ buttonCaption: _this.props.TriggerButtonDelayMessage }); // change the caption of the button to the delaymessage
            var timer = setTimeout(function () { return _this.trigger(); }, _this.props.TriggerButtonDelay); // start a timer, end when ready call trigger
            return function () { return clearTimeout(timer); }; // make sure the timer is cleaned up
        };
        /** *
         * @method trigger
        ...
        _this.trigger = function () {
            _this.setState({ config: _this.getSettings(_this.props), trigger: true }); // retrieve the configuration of this particular confetti and trigger it
            _this.setState({ buttonCaption: _this.props.TriggerButtonCaption }); // change the caption of the button to the normal caption
            if (_this.props.onClickEvent === undefined) {
                return;
            } // is there an action we need to do in de Mendix world?
            if (_this.props.onClickEvent.isExecuting) {
                return;
            } // is that action allready executing?
            _this.props.onClickEvent.execute(); // then execute that action in Mendix
        };
        _this.state = {
     ...
     */
    Confetti.prototype.componentDidUpdate = function (_prevProps) {
        ...
        if (this.props.trigger.status === "loading" /* Loading */) {
            return false;
        ...
        this.setState({
            config: this.getSettings(this.props),
            trigger: this.props.trigger.value,
     ...
     */
    Confetti.prototype.buttonElement = function () {
        return (Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_components_ButtonComponent__WEBPACK_IMPORTED_MODULE_2__["ButtonComponent"], { bootstrapStyle: this.props.bootstrapStyle, className: this.props.class, label: this.state.buttonCaption, onClick: this.onClick, style: this.props.style }, this.confettiElement()));
    };
    /**
     ...
     */
    Confetti.prototype.confettiElement = function () {
        return Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_components_ConfettiComponent__WEBPACK_IMPORTED_MODULE_1__["ConfettiComponent"], { active: this.state.trigger, config: this.state.config });
    };
    /** *
     * @method getSettings
     ...
     */
    Confetti.prototype.getSettings = function (props) {
     ...
     */
    Confetti.prototype.getDefaultSettings = function () {
        var config = {};
        config.angle = 45;
     ...
     * @returns ConfettiConfig
     */
    Confetti.prototype.getRuntimeSetting = function (props) {
        var _a, _b, _c, _d, _e, _f;
        if (((_a = props.rt_settings) === null || _a === void 0 ? void 0 : _a.status) === "loading" /* Loading */) {
            return {};
        }
        if (!((_b = props.rt_settings) === null || _b === void 0 ? void 0 : _b.items)) {
            return {};
        }
        if (((_c = props.rt_settings) === null || _c === void 0 ? void 0 : _c.items.length) === 0) {
            return {};
        }
        if (((_d = props.rt_colors) === null || _d === void 0 ? void 0 : _d.status) === "loading" /* Loading */) {
            return {};
        }
        var config = this.getDefaultSettings();
        for (var _i = 0, _g = props.rt_settings.items; _i < _g.length; _i++) {
            var i = _g[_i];
        ...
        if (!((_e = props.rt_settings) === null || _e === void 0 ? void 0 : _e.items) || ((_f = props.rt_settings) === null || _f === void 0 ? void 0 : _f.items.length) === 0) {
            return config;
        }
        var colorstring = "";
        for (var _h = 0, _j = props.rt_colors.items; _h < _j.length; _h++) {
            var i = _j[_h];
     ...
     * @returns ConfettiConfig
     */
    Confetti.prototype.getDesigntimeSettings = function (props) {
        var config = {};
...
/* harmony import */ var _ui_Button_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../ui/Button.css */ "./src/ui/Button.css");
/* harmony import */ var _ui_Button_css__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_ui_Button_css__WEBPACK_IMPORTED_MODULE_2__);



var ButtonComponent = function (props) {
    var _a;
    return (Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])("button", { className: classnames__WEBPACK_IMPORTED_MODULE_1___default()("widget--button btn", props.className, (_a = {},
            _a["btn-" + props.bootstrapStyle] = !!props.bootstrapStyle,
            _a)), onClick: props.onClick, style: props.style },
        Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])("span", { className: "widget--button-text" }, props.label),
        props.children));
};
...
var ConfettiComponent = /** @class */ (function (_super) {
    __extends(ConfettiComponent, _super);
    function ConfettiComponent() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ConfettiComponent.prototype.render = function () {
        return Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])(react_dom_confetti__WEBPACK_IMPORTED_MODULE_1___default.a, { active: this.props.active, config: this.props.config });
    };
...
var content = __webpack_require__(/*! !../../node_modules/css-loader/dist/cjs.js!../../node_modules/sass-loader/dist/cjs.js!./Button.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/ui/Button.css");
...
if(true) {
	module.hot.accept(/*! !../../node_modules/css-loader/dist/cjs.js!../../node_modules/sass-loader/dist/cjs.js!./Button.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/ui/Button.css", function() {
		var newContent = __webpack_require__(/*! !../../node_modules/css-loader/dist/cjs.js!../../node_modules/sass-loader/dist/cjs.js!./Button.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/ui/Button.css");
...
var content = __webpack_require__(/*! !../../node_modules/css-loader/dist/cjs.js!../../node_modules/sass-loader/dist/cjs.js!./Confetti.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/ui/Confetti.css");
...
if(true) {
	module.hot.accept(/*! !../../node_modules/css-loader/dist/cjs.js!../../node_modules/sass-loader/dist/cjs.js!./Confetti.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/ui/Confetti.css", function() {
		var newContent = __webpack_require__(/*! !../../node_modules/css-loader/dist/cjs.js!../../node_modules/sass-loader/dist/cjs.js!./Confetti.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/sass-loader/dist/cjs.js!./src/ui/Confetti.css");
